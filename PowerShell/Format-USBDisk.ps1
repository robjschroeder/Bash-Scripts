...
$distRootPath = '\\adroot\tss\dist'
$W10PESE_x64Directory = "$distRootPath\pub\boot_disks\WIN10PESE"
$USBDriveLetter = ""
$domain = "adroot.azwestern.edu"
$netID = Read-host "Please enter your netID ('adroot' and '-admin' are prepended/appended to your netID and not necessary)"
