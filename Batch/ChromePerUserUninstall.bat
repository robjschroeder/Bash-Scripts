...
::for /d %%A in (C:\Users\*) do (if exist "%%A\AppData\Local\Google\Chrome\" "\\adroot\tss\deploy\kaseya-pc\software\google\chrome\utilities\setup.exe" --uninstall --multi-install --chrome --force-uninstall)
