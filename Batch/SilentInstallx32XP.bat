...
ROBOCOPY "\\tss-mbrsrv1\deploy\Kaseya-PC\Software\Synoptix\Install\Synoptix" "C:\Program Files\Synoptix" /E /NP
...
XCOPY "\\tss-mbrsrv1\deploy\Kaseya-PC\Software\Synoptix\Install\.Synoptix for ellucian" "C:\Documents and Settings\%netid%\.Synoptix for ellucian" /E /I /Q /F /H /R /Y
...
XCOPY "\\tss-mbrsrv1\deploy\Kaseya-PC\Software\Synoptix\Install\Synoptix.lnk" "C:\Documents and Settings\%netid%\Start Menu\Programs\Synoptix" /I /Q /F /Y
XCOPY "\\tss-mbrsrv1\deploy\Kaseya-PC\Software\Synoptix\Install\Synoptix.lnk" "C:\Documents and Settings\All Users\Desktop" /I /Q /F /Y
