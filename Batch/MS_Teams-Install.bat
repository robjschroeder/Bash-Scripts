...
::=========================================================================================
:Install-32
XCOPY "\\adroot\tss\deploy\Kaseya-PC\Software\Microsoft\Teams\Teams_windows.msi" "C:\Temp\" /E /R /Y
msiexec /i "C:Temp\Teams_windows.msi" OPTIONS="noAutoStart=true"
GOTO :Install-Completed
::=========================================================================================
:Install-64
XCOPY "\\adroot\tss\deploy\Kaseya-PC\Software\Microsoft\Teams\Teams_windows_x64.msi" "C:\Temp\" /E /R /Y
